	...
	public class BooksSqlRepository : BaseSqlRepository<Book> {
		...
		public override List<Book> GetList() {
			using (var connection = new SqlConnection(_connectionString)) {
				var command = new SqlCommand("SELECT a.firstname, a.lastname, b.name, b.description, b.pageCount, b.genre FROM Books AS b INNER JOIN Authors AS a ON b.authorId = a.authorId", connection);
